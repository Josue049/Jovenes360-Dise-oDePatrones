...
public class Vista1 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String texto = jTextField4.getText(); // por ejemplo: "Java, Python, SQL"
        List<String> habilidades = Arrays.asList(texto.split("\\s*,\\s*"));
        
        Candidato candidato = new Candidato (nombre, email, contrasena, habilidades);
